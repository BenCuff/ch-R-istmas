#' Plots a Christmas tree in the plot pane!
#' 
#' @author Ben Cuff
...
plot_tree <- function(){
  ...
  grow <- function(tree) {
    ...
    if (tree$depth>2)  tree$col <- "darkgreen"
  ...
  par(mar=c(0,0,0,0))
  plot(x=c(-3,3),y=c(0,9),type="n",axes=FALSE)
  segplot(tree)
  
  print("Merry Christmas! (open the Plots pane to see your christmas tree!)")
}